...
urlpatterns = [
    ...
    path('api/product_by_id/', get_product_by_id_api, name='get_product_by_id_api'),
    ...
    path('preview_proposition_page_edit/', appercu_proposition_page_edit, name='appercu_proposition_page_edit'),
    ...
    path('save_draft_proposition_edit_page/', save_draft_proposition_edit_page, name='save_draft_proposition_edit_page'),
    ...
    path('send_proposal_mail_page/', send_proposal_mail_page, name='send_proposal_mail_page'),
    path('api/proposals/send-mail/', send_proposal_mail_api, name='send_proposal_mail_api'),
